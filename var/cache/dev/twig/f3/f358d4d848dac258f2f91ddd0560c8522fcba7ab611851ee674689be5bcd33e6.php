...
class __TwigTemplate_e540e79db8cc2c92ce81bbd2ae54994fa6143633c1ae79cfabc4d3644745443a extends Sonata\CacheBundle\Twig\TwigTemplate14
{
    private $source;
...
";
        // line 12
        if ((twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new Twig_Error_Runtime('Variable "admin" does not exist.', 12, $this->source); })()), "isGranted", array(0 => "EDIT", 1 => (isset($context["object"]) || array_key_exists("object", $context) ? $context["object"] : (function () { throw new Twig_Error_Runtime('Variable "object" does not exist.', 12, $this->source); })())), "method") && twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new Twig_Error_Runtime('Variable "admin" does not exist.', 12, $this->source); })()), "hasRoute", array(0 => "edit"), "method"))) {
            // line 13
            echo "    <a href=\"";
...
{% endif %}
", "@SonataAdmin/CRUD/list__action_edit.html.twig", "E:\\ESTUDIO\\TESIS\\sucu_etecsa\\app\\Resources\\SonataAdminBundle\\views\\CRUD\\list__action_edit.html.twig");
    }
}
